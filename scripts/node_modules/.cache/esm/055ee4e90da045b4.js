let Boleto;_0da‍.x([["RemessaSafra",()=>RemessaSafra]]);_0da‍.w("../Boleto",[["Boleto",["Boleto"],function(v){Boleto=v}]]);
       class RemessaSafra {
    constructor(Sacado, Cedente) {
        this.Sacado = Sacado;
        this.Cedente = Cedente;
        this._ArquivoRemessa = {
            Header: {},
            Detalhamento: {},
            Trailer: {}
        };
    ...
    get ArquivoRemessaStr() {
        return (this._ArquivoRemessa.Header.TipoRegistro.valor + this._ArquivoRemessa.Header.CodArquivo.valor
    ...
    get LinhaDetalheRemessaProtoType() {
        return {
            TipoRegistro: { mascara: "9(01)", posicao: 1, tamanho: 1, valor: "" },
    ...
    carregarHeaderArquivo(Sacado, Cedente) {
    ...
    validarHeaderArquivo(header) {
        return (Boleto.validarMascara(header.TipoRegistro)
    ...
    carregarLinhaDetalheArquivo(Sacado, Cedente) {
    ...
    validarTrailerArquivo(trailer) {
        return (Boleto.validarMascara(trailer.TipoRegistro)
